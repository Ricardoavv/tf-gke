...
#terraform directory
terraform_dir = '/Users/Documents/tf-gke/terraform' #this is an example, change to your working directory
...
KEY_FILE_LOCATION = 'service.json' # make a service account key, download and place into AI directory
...
print(avg_metric)
if tf.reduce_all(avg_metric >= high_threshold):
...
elif  tf.reduce_any(avg_metric <= low_threshold):
